...
import { PixelCommunity } from '../stickers';
import { ArrowRight, HeartHandshake, ShieldAlert } from 'lucide-react';

export function Manifesto() {
  return (
    <section className="py-16 my-12">
      <div className="pixel-card-static bg-amber-50/60 dark:bg-zinc-800/60 p-8 sm:p-12 border-2 border-zinc-900 dark:border-zinc-700 relative overflow-hidden transition-colors duration-300">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          
          <div className="lg:col-span-8 space-y-6">
            <div className="inline-flex items-center gap-2 bg-[#FFD43B] text-zinc-900 border border-zinc-900 dark:border-zinc-700 px-3 py-1 text-xs font-pixel font-bold shadow-[2px_2px_0px_var(--pixel-shadow-color)]">
            ...
            <div className="space-y-4 text-zinc-700 dark:text-zinc-300 text-sm sm:text-base leading-relaxed font-medium">
              <p>
            ...
            <div className="bg-white dark:bg-zinc-800 p-4 border-2 border-zinc-900 dark:border-zinc-700 shadow-[3px_3px_0px_var(--pixel-shadow-color)] space-y-2">
            ...
            <div className="pt-2 flex flex-wrap gap-4">
              ...
              <Link
                to="/about"
                className="pixel-btn px-5 py-3 text-xs sm:text-sm font-bold"
              >
          ...
          <div className="lg:col-span-4 flex flex-col items-center justify-center text-center p-6 bg-white dark:bg-zinc-800 border-2 border-zinc-900 dark:border-zinc-700 shadow-[4px_4px_0px_var(--pixel-shadow-color)] space-y-4">
            <PixelCommunity className="w-24 h-24" />
            <div className="space-y-1">
              <h4 className="font-pixel text-sm text-zinc-900 dark:text-zinc-100 font-bold">ATMIYA UNIVERSITY</h4>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 font-mono">Rajkot, Gujarat • India</p>
            </div>
            <div className="w-full pt-4 border-t border-zinc-200 dark:border-zinc-700 text-xs font-semibold text-zinc-700 dark:text-zinc-300">
