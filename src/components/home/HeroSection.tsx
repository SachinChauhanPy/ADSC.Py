  ...
  return (
    <section className="relative pt-6 pb-16 md:py-20 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="inline-flex items-center gap-2 bg-white border-2 border-zinc-900 px-4 py-1.5 shadow-[3px_3px_0px_#121212] font-pixel text-xs">
          <span className="w-2.5 h-2.5 bg-[#EA4335] border border-zinc-900" />
          <span className="font-bold text-zinc-900">ATMIYA UNIVERSITY • RAJKOT</span>
          <span className="text-zinc-400 font-mono">|</span>
          <span className="text-[#306998] font-bold">ADSC.Py</span>
        </div>
        ...
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-zinc-900 tracking-tight leading-[1.15]">
            ...
            <span className="bg-[#FFD43B] text-zinc-900 px-3 py-1 inline-block border-2 border-zinc-900 shadow-[4px_4px_0px_#121212] transform -rotate-1">
              Now what?
            </span>
          </h1>

          <p className="text-lg sm:text-xl text-zinc-700 max-w-2xl mx-auto leading-relaxed font-medium">
        ...
        <div className="pixel-card-static p-6 max-w-2xl mx-auto bg-amber-50/50 border-2 border-zinc-900 text-left space-y-4">
          <div className="flex items-center gap-2 text-xs font-pixel text-zinc-700">
              ...
              <button
                ...
                className={`w-full text-left p-3 text-sm font-semibold transition-all border-2 flex items-center justify-between ${
                  selectedFeeling === f.id
                    ? 'bg-zinc-900 text-white border-zinc-900 shadow-[3px_3px_0px_#FFD43B]'
          ...
          {selectedFeeling && (
            <div className="bg-white p-4 border-2 border-zinc-900 shadow-[2px_2px_0px_#121212] space-y-3 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          ...
          <Link
            to="/paths"
            className="pixel-btn w-full sm:w-auto px-6 py-4 text-base flex items-center justify-center gap-2 font-bold text-zinc-800"
          >
