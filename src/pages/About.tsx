  ...
  return (
    <Shell>
      <div className="space-y-12 max-w-4xl mx-auto">
        ...
        {/* The Core Problem */}
        <div className="pixel-card-static p-8 bg-white border-2 border-zinc-900 space-y-4">
          <div className="flex items-center gap-3">
            <Target className="w-8 h-8 text-[#EA4335]" />
            <h2 className="text-2xl font-extrabold text-zinc-900">The Problem We Are Solving</h2>
          </div>
          ...
          <p className="text-zinc-700 text-base leading-relaxed font-medium">
            However, a massive gap exists right after learning syntax: <strong className="text-zinc-900 bg-amber-100 px-1">Students don't know what to build or where Python can take them.</strong> They get trapped in endless YouTube tutorial loops without building real software or gaining industry exposure.
          </p>
        </div>

        {/* The Solution Pillars */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="pixel-card p-6 bg-blue-50/60 border-2 border-zinc-900 space-y-3">
            <PixelCompass className="w-10 h-10" />
            <h3 className="font-extrabold text-lg text-zinc-900">1. UNDERSTAND</h3>
          ...
          <div className="pixel-card p-6 bg-amber-50/60 border-2 border-zinc-900 space-y-3">
            <PixelBook className="w-10 h-10" />
            <h3 className="font-extrabold text-lg text-zinc-900">2. PREPARE</h3>
            <p className="text-xs text-zinc-700 leading-relaxed font-medium">
              We offer structured project blueprints with feature checklists and peer code reviews so students build capability.
            </p>
          </div>

          <div className="pixel-card p-6 bg-emerald-50/60 border-2 border-zinc-900 space-y-3">
            <PixelPython className="w-10 h-10" />
            <h3 className="font-extrabold text-lg text-zinc-900">3. GET EXPOSURE</h3>
            <p className="text-xs text-zinc-700 leading-relaxed font-medium">
        ...
        {/* Brand Rules & Honesty */}
        <div className="pixel-card-static p-8 bg-zinc-900 text-white border-2 border-zinc-900 space-y-4">
          <div className="flex items-center gap-3">
